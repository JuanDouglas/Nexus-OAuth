...
{
    internal class CaptureStateCallback : CameraDevice.StateCallback, ImageReader.IOnImageAvailableListener
    {
        public CameraCharacteristics Characteristics { get; set; }
        public SurfaceView SurfaceView { get; set; }
        public CaptureStateCallback(SurfaceView surfaceView, CameraCharacteristics characteristics)
        {
