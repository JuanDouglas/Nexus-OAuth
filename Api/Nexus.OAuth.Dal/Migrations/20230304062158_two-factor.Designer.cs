...
namespace Nexus.OAuth.Dal.Migrations
{
    ...
    [Migration("20230304062158_two-factor")]
            ...
            modelBuilder.Entity("Nexus.OAuth.Dal.Models.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2023, 3, 4, 6, 21, 58, 313, DateTimeKind.Utc).AddTicks(146),
                            Culture = "pt-br",
            ...
            modelBuilder.Entity("Nexus.OAuth.Dal.Models.File", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Inserted = new DateTime(2023, 3, 4, 6, 21, 58, 313, DateTimeKind.Utc).AddTicks(269),
                            Length = 2333L,
                            ResourceOwnerId = 1,
                            Type = (short)2
                        });
