...
namespace Nexus.OAuth.Dal.Migrations
{
    ...
    [Migration("20230309041025_add_await_tfa")]
    partial class add_await_tfa
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Nexus.OAuth.Dal.Models.Account", b =>
                {
                    ...
                    b.Property<bool>("TFAEnable")
                        .HasColumnType("bit");

                    b.Property<byte>("TFAType")
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2023, 3, 9, 4, 10, 24, 822, DateTimeKind.Utc).AddTicks(4798),
                            Culture = "pt-br",
            ...
            modelBuilder.Entity("Nexus.OAuth.Dal.Models.File", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Inserted = new DateTime(2023, 3, 9, 4, 10, 24, 822, DateTimeKind.Utc).AddTicks(4889),
                            Length = 2333L,
                            ResourceOwnerId = 1,
                            Type = (short)2
                        });
